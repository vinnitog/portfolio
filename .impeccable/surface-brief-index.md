...
| Headline | Principal âncora de leitura, até duas linhas | HTML semântico + fonte self-hosted |
| Rota e nós | Linha contínua, quatro camadas, ramificação para cases | SVG inline responsivo + botões semânticos |
...
| Projetos | Tabs recortadas, títulos e tecnologias confirmadas | Links semânticos + CSS/SVG |
| Movimento | Desenho inicial da rota e realce contextual | CSS/JS, removido sob reduced motion |
| Conteúdo posterior | Experiência, método, competências, cases e contato | HTML semântico no mesmo mundo editorial |
