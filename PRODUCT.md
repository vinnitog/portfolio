...
- Os links externos devem abrir os perfis e repositórios reais fornecidos pelo usuário, e o contato direto deve usar `mailto:vinnitog@gmail.com`.
- Divisores editoriais devem atravessar a viewport com traço pontilhado e um X terminal.
- O app shell `portfolio-v22` deve manter os três frames do runner disponíveis offline e limpar somente versões antigas com o namespace `portfolio-v`.
