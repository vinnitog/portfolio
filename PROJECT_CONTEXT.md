...
- Banco de dados: Nao
- Offline/PWA: Sim, com app shell estatico instalavel `portfolio-v22` e navegacao principal disponivel offline
- Mobile: Sim
...
- A secao Projetos usa um unico case principal para o VerbaJus, pronto para uso, seguido por um indice editorial compacto com TX Raio-X, RDP Pro, Togs Heads Up, Jogos de Hoje e Casa dos Coleus. Os seis links de repositorio permanecem externos e seguros.
- App shell `portfolio-v22` precacheia os tres PNGs do runner e seus demais assets essenciais; cada PNG tem arquivo de proveniencia. A ativacao remove somente caches antigos com o prefixo `portfolio-v`, preservando caches de outros projetos na mesma origem GitHub Pages.
